...
// Using these arrays, the function must create an object of type Map, the keys of which are the values from the first array keys,
// and the values of Map - the values from the second array values.
